...
def get_res_5(cc_obj, amp):
    ...
    res +=     1.000000 * einsum('jkbc,acji,IJbk->IJai', cc_obj.h2e.oovv, amp[1], amp[4])
    res +=     0.500000 * einsum('jkbc,ackj,IJbi->IJai', cc_obj.h2e.oovv, amp[1], amp[4])
    res +=     0.500000 * einsum('jkbc,cbji,IJak->IJai', cc_obj.h2e.oovv, amp[1], amp[4])
    ...
    res +=    -0.500000 * einsum('jkbc,aj,ck,IJbi->IJai', cc_obj.h2e.oovv, amp[0], amp[0], amp[4])
    res +=     0.500000 * einsum('jkbc,aj,Ici,Jbk->IJai', cc_obj.h2e.oovv, amp[0], amp[2], amp[2])
    res +=    -0.500000 * einsum('jkbc,aj,Ick,Jbi->IJai', cc_obj.h2e.oovv, amp[0], amp[2], amp[2])
    res +=     0.500000 * einsum('jkbc,ci,aj,IJbk->IJai', cc_obj.h2e.oovv, amp[0], amp[0], amp[4])
    res +=    -0.500000 * einsum('jkbc,ci,bj,IJak->IJai', cc_obj.h2e.oovv, amp[0], amp[0], amp[4])
    res +=     0.500000 * einsum('jkbc,ci,Iaj,Jbk->IJai', cc_obj.h2e.oovv, amp[0], amp[2], amp[2])
    res +=    -0.500000 * einsum('jkbc,ci,Ibj,Jak->IJai', cc_obj.h2e.oovv, amp[0], amp[2], amp[2])
    res +=     0.500000 * einsum('jkbc,cj,Iak,Jbi->IJai', cc_obj.h2e.oovv, amp[0], amp[2], amp[2])
    res +=     0.500000 * einsum('jkbc,cj,Ibi,Jak->IJai', cc_obj.h2e.oovv, amp[0], amp[2], amp[2])
    return res
