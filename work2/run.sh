...
time python gen-cceqs.py 1 4 2 0 > $LOG_TMPDIR/1420.log
...
time python gen-cceqs.py 1 2 6 0 > $LOG_TMPDIR/1260.log
time python gen-cceqs.py 1 4 6 0 > $LOG_TMPDIR/1460.log
